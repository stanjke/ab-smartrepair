...
const Check: FC<IconProps> = ({ viewBox = "0 0 24 24", width = "16", height = "16", className }) => {
  return (
    <svg width={width} height={height} className={className} clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
